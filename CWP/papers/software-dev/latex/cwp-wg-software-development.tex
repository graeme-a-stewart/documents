...
\begin{tabular*}{\linewidth}{lc@{\extracolsep{\fill}}r@{\extracolsep{0pt}}}
 & & HSF-CWP-2017-13 \\
 & & December 22, 2017 \\ % use \date or hardwire e.g. December 15, 2017
 & & \\
\end{tabular*}
\vspace{2.0cm}
...
USA}
\affiliation[d]{Soundcloud, Berlin, Germany}
...
Tracker~\cite{GitHubIssues}, Jira~\cite{Jira}, GitLab Issue
Tracker~\cite{GitLabIssues}) and the choice should usually be made in parallel
with an source code management (SCM) tool.
...
these sites. There are commercial choices, such as GitHub or BitBucket %REF?
that can serve a community well; alternatively a privately hosted
service, such as CERN's GitLab instance, may mesh more easily with other %REF?
...
exist (Jenkins, Gitlab CI, Travis, Bamboo) and the particular choice of %REF?
